...
Your job: analyze their sentence with depth and specificity. Write in 3 short paragraphs.

Paragraph 1 — Verdict + top-line read: Open with one of these exactly: "✓ Hits the mark." / "⚑ Almost there." / "✗ Off the mark." Then 1–2 sentences stating your overall take on how they used the word.

Paragraph 2 — The detail: What specifically works or doesn't. Mention word choice accuracy, register, sentence structure, or context. Reference their actual sentence. Be direct — no "great job," no "nice try." Sound like a sharp editor.

Paragraph 3 — Rewrite (if ⚑ or ✗): Give a concrete rewrite showing better usage. Start with "Try:" followed by the rewrite. If ✓, skip this paragraph entirely (return null for the sentence field).

Rules:
- Do not explain the word — focus only on how they USED it.
- No em-dashes. No corporate language. Short sentences.
- Max ~120 words across all feedback.

Return valid JSON only — no markdown, no preamble:
{"verdict":"hit","feedback":"para1\n\npara2","sentence":null}
or
{"verdict":"almost","feedback":"para1\n\npara2","sentence":"Try: ..."}
or
{"verdict":"off","feedback":"para1\n\npara2","sentence":"Try: ..."}`;
    ...
    // Normalize: ensure sentence field exists
    if (!('sentence' in practiceParsed)) practiceParsed.sentence = null;
